...
void CFiguras::prisma3(GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	glTexCoord2f(20.0f, 20.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 20.0f); glVertex3fv(vertice[7]);
...
void CFiguras::cilindro(float radio, float altura, int resolucion, GLuint text1, GLuint text2)
{
	...
	for(int i=0; i <resolucion; i++)
	{
		...
		glBegin(GL_POLYGON);
			glNormal3f( 0.0f, -1.0f, 0.0f);
			glTexCoord2f(0, 0.0f);	glVertex3f(0.0,0.0,0.0);
			glTexCoord2f(1, 0.0f);  glVertex3fv(v2);
			glTexCoord2f(0, 1.0f);	glVertex3fv(v3);
		glEnd();

		glBindTexture(GL_TEXTURE_2D, text2);
		glBegin(GL_POLYGON);
			glNormal3f( 0.0f, 1.0f, 0.0f);
			glTexCoord2f(0, 0.0f);	glVertex3f(0.0,altura,0.0);
			glTexCoord2f(1, 0.0f);	glVertex3fv(v4);
			glTexCoord2f(0, 1.0f);	glVertex3fv(v5);
		glEnd();
